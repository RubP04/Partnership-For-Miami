    ...
    <div className="landing-page">
      <section id="home" className="landing-section">
        <div className="text-content">
          ...
          <p>
            Legal Loop is your ultimate destination for staying connected to all the latest updates and happenings in your local government. 
            ...
            With Legal Loop, you’ll never miss an important update that impacts your community.
          </p>
        </div>
      ...
      <section className="landing-section">
        ...
        <div className="text-content">
          <h2>Stay Informed</h2>
          <p>
            Keeping up with local government activities can be overwhelming, but Legal Loop simplifies the process for you. 
      ...
      <section className="landing-section">
        <div className="text-content">
          ...
          <p>
           ...
           Legal Loop encourages civic engagement by providing you with tools to connect with like-minded individuals, 
      ...
      <section className="landing-section call-to-action">
        <div className="text-content">
          ...
          <p>
            Join Legal Loop today and stay informed, engaged, and connected with everything happening in your local community. 
